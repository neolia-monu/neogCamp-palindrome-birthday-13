const bdayInput = document.querySelector("#date-of-birth");
const showBtn = document.querySelector("#calculate-number");
...
function clickHandler(e) {
    ...
    if (bdayString !== "") {
        ...
        if (!isPalindrome) {
            ...
            if (ctr1 > ctr2) {
                showMessage(`The nearest palindrome date is ${prevDate.day}-${prevDate.month}-${prevDate.year}, you missed by ${ctr2} days.`, false);
            } else {
                showMessage(`The nearest palindrome date is ${nextDate.day}-${nextDate.month}-${nextDate.year}, you missed by ${ctr1} days.`, false);
            }
        } else {
            showMessage("Yay! Your birthday is palindrome!", true);
        }
    }
}
